...
def main():
    parser = argparse.ArgumentParser(description='SGN Single-Actor Training')
    ...
    model_dir = f'{args.dataset}_{args.tag}_{split_tag}'
    ...
    print(f"Creating SGN model with {num_classes} classes for {args.dataset} dataset")
    ...
    # Create the model
    model = SGN(num_classes=num_classes, dataset=args.dataset, seg=args.seg)
