#!/bin/bash
#SBATCH --job-name=comprehensive_eval_pmr_ntu_cv
...
#SBATCH --gres=gpu:1
#SBATCH --mem=64GB
#SBATCH --output=logs/comprehensive_eval_pmr_ntu_cv_%j.out
#SBATCH --error=logs/comprehensive_eval_pmr_ntu_cv_%j.err
...
python eval_model.py \
    ...
    --transformer_model_path trained_models/pmr_ntu_cv_best.pth \
    --output_dir results/comprehensive/ntu_cv/pmr_mixformer \
