#!/bin/bash
#SBATCH --job-name=comprehensive_eval_transformer_ntu_cv
...
#SBATCH --gres=gpu:1
#SBATCH --mem=64GB
#SBATCH --output=logs/comprehensive_eval_transformer_ntu_cv_%j.out
#SBATCH --error=logs/comprehensive_eval_transformer_ntu_cv_%j.err
...
python eval_model.py \
    ...
    --transformer_model_path model_all.pth \
    --output_dir results/comprehensive/ntu_cv/transformer_mixformer \
