...
A unified, comprehensive evaluation framework for the Transformer Retargeting project.

## 🚀 Quick Start

```bash
# Run all primary experiments
python evaluation_suite/run_experiments.py --experiment-set primary

# Run specific experiment
python evaluation_suite/run_experiments.py --experiment loss_ablation

# Generate comprehensive report
python evaluation_suite/generate_report.py --output reports/latest_results.pdf
```
