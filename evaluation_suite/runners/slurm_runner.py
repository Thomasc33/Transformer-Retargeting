...
class SlurmRunner:
    ...
    def __init__(self, hpc_config: Dict[str, Any]):
        ...
        self.job_dir = Path("evaluation_suite/runners/jobs")
    ...
    def generate_script_content(self, experiment_name: str, experiment_config: Dict[str, Any],
        ...
        defaults = {
            ...
            'ntasks_per_node': self.config.get('default_ntasks_per_node', 4),
            'gres': self.config.get('default_gres', 'gpu:4'),
            'mem': self.config.get('default_mem', '200GB')
        }
        ...
        script_lines = [
            ...
            "mkdir -p slurm_out",
            "mkdir -p evaluation_suite/results/experiments",
            "",
            "# Run the experiment",
            f"python evaluation_suite/run_experiments.py --experiment {experiment_name}",
            "",
