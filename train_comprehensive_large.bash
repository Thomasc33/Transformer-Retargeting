#!/bin/bash
#
#SBATCH --job-name="mixformer-comprehensive-large"
...
# Run the training script with torchrun to utilize all 6 GPUs
# Using the comprehensive dataset with cross-view setting
# Using a larger sample size for more comprehensive training
torchrun --nproc_per_node=4 main.py --dataset ntu --setting cv --hpc \
    ...
    --train-samples 50000 \
    --test-samples 10000 \
    --output-model-path model_comprehensive_large.pth
